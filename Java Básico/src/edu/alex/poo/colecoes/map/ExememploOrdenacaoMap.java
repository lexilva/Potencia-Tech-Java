...
public class ExememploOrdenacaoMap {
    public static void main(String[] args) {
        ...
        Map<String,Livro> meusLivros1 = new LinkedHashMap<>(){{
           put(" HawKing, Stepehen", new Livro("Uma Breve História do tempo",256));
           put(" Duhigg, Charles", new Livro(" O poder do Hábito",408));
           put(" Harari, Yuval Noar", new Livro("22 Lições para o Século 21",432));
        }};
